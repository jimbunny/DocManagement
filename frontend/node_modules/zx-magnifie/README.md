# zx-magnifie(作者:初志鑫<1204505056@qq.com>)
...
<template>
	<div id="app">
		...
		<div style="width:60%;display:inline-block"><byui-magnifie :width="width" :url="url" :type="type" :scale="scale" /></div>
		<p>当前放大倍数：{{ scale }}</p>
		<p>当前放大镜宽度：{{ width }}</p>
