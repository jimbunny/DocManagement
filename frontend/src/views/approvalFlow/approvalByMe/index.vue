<template>
  <div class="userManagement-container">
    ...
    >
      ...
      <el-table-column prop="date1" label="审批时间"></el-table-column>
...
export default {
  ...
  data() {
    return {
      list: null,
      dataList: [{"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "date1": "2021-11-22 11:00", "status": "部门主管（李四）"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "date1": "2021-11-22 11:00", "status": "部门主管（李四）"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "date1": "2021-11-22 11:00", "status": "部门主管（李四）"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "date1": "2021-11-22 11:00", "status": "部门主管（李四）"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "date1": "2021-11-22 11:00", "status": "部门主管（李四）"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "date1": "2021-11-22 11:00", "status": "部门主管（李四）"}],
