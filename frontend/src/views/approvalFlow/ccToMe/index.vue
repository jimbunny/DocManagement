...
export default {
  ...
  data() {
    return {
      list: null,
      dataList: [{"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "status": "等待审批"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "status": "等待审批"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "status": "审批通过"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "status": "审批通过"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "status": "审批通过"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "status": "审批通过"}],
      listLoading: true,
