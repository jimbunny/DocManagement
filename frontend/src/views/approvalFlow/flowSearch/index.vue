<template>
  <div class="userManagement-container">
    ...
    >
      ...
      <el-table-column prop="now" label="当前节点"></el-table-column>
...
export default {
  ...
  data() {
    return {
      list: null,
      dataList: [{"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "now": "部门主管（allen）", "status": "等待审批"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "now": "部门主管（allen）", "status": "等待审批"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "now": "部门主管（allen）", "status": "审批通过"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "now": "部门主管（allen）", "status": "审批通过"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "now": "部门主管（allen）", "status": "审批通过"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "now": "部门主管（allen）", "status": "审批通过"}],
      listLoading: true,
