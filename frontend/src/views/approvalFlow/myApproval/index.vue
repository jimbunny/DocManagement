  ...
  <el-row :gutter="20">
    ...
    >
      ...
      <el-table-column fixed="right" :label="$t('user.action')" width="300">
        ...
        <el-button type="text" style="color:#67c23a;" @click='$baseMessage("催办成功！","success")'
            >催办
          </el-button>
          <el-button type="text" @click="handleEdit(scope.row)"
            >查看
          </el-button>
          <el-button type="text" style="color:#f56c6c;" @click='$baseMessage("撤销成功！","success")'
            >撤销
          </el-button>
        </template>
      </el-table-column>
...
export default {
  ...
  data() {
    return {
      list: null,
      dataList: [{"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "status": "已完成"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "status": "已完成"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "status": "已完成"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "status": "已完成"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "status": "已完成"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "status": "已完成"}],
