  ...
  <div class="userManagement-container">
    ...
    <byui-query-form>
      <byui-query-form-left-panel :span="12">
        <el-button type="primary" @click='$baseMessage("同意成功！","success")'
          >同意
        </el-button>
        <el-button type="danger" @click='$baseMessage("拒绝成功！","success")'
          >拒绝
        </el-button>
        <el-button type="warning" @click='$baseMessage("撤回成功！","success")'
          >撤回
        </el-button>
    ...
    >
      ...
      <el-table-column prop="number" label="流程编号"></el-table-column>
      <el-table-column prop="title" label="流程标题"></el-table-column>
      <el-table-column prop="date" label="申请时间"></el-table-column>
      <el-table-column prop="status" label="上个节点"></el-table-column>
      <el-table-column fixed="right" :label="$t('user.action')" width="300">
        ...
        <el-button type="text" @click="handleEdit(scope.row)"
          ...
          <el-button type="text" @click='$baseMessage("拒绝成功！","success")' style="color:#f56c6c;"
            >拒绝
          </el-button>
        </template>
      </el-table-column>
...
export default {
  ...
  data() {
    return {
      list: null,
      dataList: [{"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "status": "部门主管（李四）"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "status": "部门主管（李四）"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "status": "部门主管（李四）"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "status": "部门主管（李四）"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "status": "部门主管（李四）"},
      {"number": "QJ12313131241", "title": "JTS数据修改", "date": "2021-11-22 10:00", "status": "部门主管（李四）"}],
